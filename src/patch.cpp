...
void patch_combat_roll()
{
    ...
    */
    ...
    /*
    0:  8d 7d 90                lea    edi,[ebp-0x70]
    3:  57                      push   edi
    4:  8d 7d 98                lea    edi,[ebp-0x68]
    7:  57                      push   edi
    8:  8b 7d f8                mov    edi,DWORD PTR [ebp-0x8]
    b:  57                      push   edi
    c:  8b 7d fc                mov    edi,DWORD PTR [ebp-0x4]
    f:  57                      push   edi
    10: 8b 7d e4                mov    edi,DWORD PTR [ebp-0x1c]
    13: 57                      push   edi
    14: 8b 7d ec                mov    edi,DWORD PTR [ebp-0x14]
    17: 57                      push   edi
    18: e8 fc ff ff ff          call   <combat_roll>
    1d: 83 c4 18                add    esp,0x18
    20: 85 c0                   test   eax,eax
    ...
    */
    byte combat_roll_new_bytes[] =
        { 0x8D, 0x7D, 0x90, 0x57, 0x8D, 0x7D, 0x98, 0x57, 0x8B, 0x7D, 0xF8, 0x57, 0x8B, 0x7D, 0xFC, 0x57, 0x8B, 0x7D, 0xE4, 0x57, 0x8B, 0x7D, 0xEC, 0x57, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x83, 0xC4, 0x18, 0x85, 0xC0, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }
    ;
