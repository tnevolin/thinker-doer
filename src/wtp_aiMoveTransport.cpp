...
{
	assert(seaTransportVehicleId >= 0 && seaTransportVehicleId < *VehCount);
	assert(passengerVehicleId >= 0 && passengerVehicleId < *VehCount);
	...
	if (isOceanRegion(destination->region) && !map_has_item(destination, BIT_BASE_IN_TILE))
