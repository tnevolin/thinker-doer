...
//    }
    ...
    else if (MATCH("promotion_probability_denominator"))
    {
    ...
    else if (MATCH("needlejet_air_superiority_required"))
    {
        cf->needlejet_air_superiority_required = (atoi(value) == 0 ? false : true);
    }
    else if (MATCH("datalinks_sort"))
    {
