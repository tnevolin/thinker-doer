...
#ifdef BUILD_REL
    #define MOD_VERSION "Thinker Mod v4.6 - The Will to Power mod v361"
#else
...
struct Config {
    ...
    double ai_production_expansion_priority_bonus;
    double ai_production_expansion_priority_bonus_base_scale;
