...
//	int free_minerals = 16;
    ...
    double ai_faction_income_a;
    double ai_faction_income_b;
    double ai_faction_income_c;
    double ai_faction_income_t1;
    double ai_base_income_a;
    double ai_base_income_b;
